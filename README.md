...
**Working towards becoming a Lead Cloud Infrastructure Engineer** based in London, UK.

I bring 4+ years of background across database administration, analytics engineering, and regulated environments, currently specializing in **Cloud Security Architecture and Infrastructure-as-Code (AWS & Terraform)**. Im focused on building reliable data systems, automated governance pipelines, and zero-trust cloud security controls.
...
| **[Cohort Revenue & Retention Engine](https://github.com/Pliauga/uk-property-analytics-pipeline)** | E-commerce retention and revenue engine built on 1M+ UK transaction logs. Features month-over-month retention heatmaps and statistical anomaly detection. | Python · SQL · pandas · seaborn |
